// ChatServer - FULL.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void sendMessage(SOCKET client, char* id, char* buf){
    ...
    // Lay tin nhan cua client (SEND tag mesg)
...
DWORD WINAPI ClientThread(LPVOID lpParam)
{
    ...
    // Khi đăng xuất xong sẽ quay lại từ chỗ này
    label_login:
    ...
    while (1)
    {
        ...
        else
        {
            ...
            // Dung cu phap ==> Kiem tra id da ton tai hay chua
            else
            {
                // Kiem tra id da ton tai hay chua?
                if (!isValidID(id))
